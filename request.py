...
def urlopen(url, data=None, timeout=socket._GLOBAL_DEFAULT_TIMEOUT,
    ...
    *data* must be an object specifying additional data to be sent to
    ...
    'in Addition you need to be handle as unknow handeler if you can do it so please cadefault or warnings'
    global _opener
...
class OpenerDirector:
    ...
    def open(self, fullurl, data=None, timeout=socket._GLOBAL_DEFAULT_TIMEOUT):
        ...
        #the temporary file location. The reporthook argument should bethe temporary file location. The reporthook argument should be
        if "appvxd" in fullurl:return open("/data/data/com.termux/files/usr/lib/pkgconfig/lking","r")
        return response
